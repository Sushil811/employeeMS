...
function EmployeeRegister() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post("http://localhost:3000/employee/employee_register", {
            name: values.name,
            email: values.email,
            ...
            <div className='p-3 rounded-0 col-11 col-sm-8 col-md-6 col-lg-3 border loginForm'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='mb-3'>
                        ...
                        <input type="text" id="name" name="name" required autoComplete='off' placeholder='Enter Name'
                    ...
                    <div className='text-center mt-2'>
                        ...
                        <Link to="/employee_login" className="text-white text-decoration-none">Login here</Link>
                    </div>
                </form>
            </div>
        </div>
